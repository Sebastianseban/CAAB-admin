...
// import DepartmentForm from "./DepartmentForm"; // ✅ reusable form
...
//         (d) => d.id === selectedDepartmentId || d.Id === selectedDepartmentId // ✅ handle both id/Id
//       );
//       if (dept) {
//         setFormData({
...
//       {
//         onSuccess: () => {
//           setIsEditDepartmentPopupOpen(false); // ✅ close modal
//         },
//         onError: (err) => {
